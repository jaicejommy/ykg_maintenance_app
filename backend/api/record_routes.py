    ...
    try:
        ...
        execute(
            ...
            (
                ...
                update_data.planned_start if update_data.planned_start is not None else row["planned_start"],
                update_data.planned_end if update_data.planned_end is not None else row["planned_end"],
                update_data.remarks if update_data.remarks is not None else row["remarks"],
                now_iso,
                username,
                now_iso,
                record_id,
